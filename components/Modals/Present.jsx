...
export default function Present({ open, setOpen }) {
  console.log(open);
  return (
    <>
      <div id="get-present" className="modal_htmlForm">
        <div className="top-htmlForm popup">
          <div className="close">&times;</div>
          <form
            action=""
            method="post"
            className="custom-htmlForm modal-htmlForm ajax_htmlForm"
          >
            {/*
                <div className="modal-title">Заполните форму для получения презентации</div>
                */}
            ...
            <input type="hidden" name="which_htmlForm" value="" />
            ...
            <input
              ...
              value=""
            />
            <input type="hidden" name="utm_mail" className="source" value="" />
            ...
            <div className="polit-descr">
              Нажимая кнопку "Получить презентацию", я подтверждаю, что
